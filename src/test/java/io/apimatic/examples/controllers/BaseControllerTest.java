...
public class BaseControllerTest {
     ...
     */
    protected static CalculatorMHarisClient createConfigurationFromEnvironment() {
        CalculatorMHarisClient.Builder builder = new CalculatorMHarisClient.Builder();

        final String environment = System.getenv("CALCULATOR_M_HARIS_LIB_ENVIRONMENT");
        final String timeout = System.getenv("CALCULATOR_M_HARIS_LIB_TIMEOUT");
     ...
     */
    protected static CalculatorMHarisClient createConfiguration() {
        // Set Configuration parameters for test execution
        CalculatorMHarisClient config = createConfigurationFromEnvironment();
