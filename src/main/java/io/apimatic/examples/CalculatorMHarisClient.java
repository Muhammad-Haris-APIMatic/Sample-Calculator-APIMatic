 ...
 */
public final class CalculatorMHarisClient implements Configuration {
    ...
    private CalculatorMHarisClient(Environment environment, HttpClient httpClient,
    ...
    /**
     * Converts this CalculatorMHarisClient into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CalculatorMHarisClient [" + "environment=" + environment + ", httpClientConfig="
                + httpClientConfig + ", authManagers=" + authManagers + "]";
    }

    /**
     * Builds a new {@link CalculatorMHarisClient.Builder} object.
     * Creates the instance with the state of the current client.
     * @return a new {@link CalculatorMHarisClient.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CalculatorMHarisClient}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new CalculatorMHarisClient object using the set fields.
         * @return CalculatorMHarisClient
         */
        public CalculatorMHarisClient build() {
            HttpClientConfiguration httpClientConfig = httpClientConfigBuilder.build();
            httpClient = new OkClient(httpClientConfig);

            return new CalculatorMHarisClient(environment, httpClient, httpClientConfig,
